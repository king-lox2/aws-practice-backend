...
const verifyOrder = async (req, res) => {
  ...
  try {
    if (success === "true") {
      ...
      res.status(StatusCodes.OK).json({ success: true, message: "Paid" });
    } else {
...
const userOrders = async (req, res) => {
  try {
    ...
    console.log(error);
    res.json({ success: false, message: "error in orders" });
  }
};
...
export { placeOrder, verifyOrder, userOrders, listOrdersAdmin, orderStatus };
